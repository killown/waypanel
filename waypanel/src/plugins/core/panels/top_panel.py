...
class TopPanelPlugin(BasePlugin):
    ...
    def add_css_class(self):
        if (
            self.utils.is_widget_ready(self.obj.top_panel_box_left)
            and self.utils.is_widget_ready(self.obj.top_panel_box_widgets_left)
            and self.utils.is_widget_ready(self.obj.top_panel_box_right)
            and self.utils.is_widget_ready(self.obj.top_panel_box_systray)
            and self.utils.is_widget_ready(self.obj.top_panel_box_center)
