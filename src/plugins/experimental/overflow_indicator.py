...
class OverflowIndicator(BasePlugin):
    ...
    def __init__(self, panel_instance):
        ...
        self.hidden_widgets_box = self.gtk.Box.new(self.gtk.Orientation.HORIZONTAL, 0)
        ...
        self.revealer.set_transition_type(self.gtk.RevealerTransitionType.SLIDE_RIGHT)
