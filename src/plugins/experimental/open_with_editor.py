...
class OpenWithEditor(BasePlugin):
    ...
    def _setup_tabbed_ui(self):
        ...
        self.stack.set_transition_type(self.gtk.StackTransitionType.SLIDE_LEFT_RIGHT)
    ...
    def _populate_listbox(self, listbox, directory_path, searchbar):
        ...
        for file_path in files_to_list:
            ...
            click_gesture.connect(
                "pressed",
                lambda gesture, n_press, x, y, box=row_hbox: self._handle_file_click(
                    gesture, n_press, x, y, box
                ),
            )
